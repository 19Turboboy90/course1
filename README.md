...
Потоки - демоны завершают свою работу после завершения всех основных потоков.
...
1. Чем отличается синхронизированный метод от несинхронизированного?
...
5. Какие из этих методов могут работать одновременно их разных потоков, а какие нет и почему?
